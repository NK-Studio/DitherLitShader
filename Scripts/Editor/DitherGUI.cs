...
namespace NKStudio
{
    public class DitherGUI : BaseShaderGUI
    {
        ...
        private MaterialProperty _ditherThreshold;
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            _ditherThreshold = FindProperty("_DitherThreshold", properties);
        ...
        private void DrawNKLitShaderGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                InspectorBox(10, () =>
                {
                    ...
                    if (alphaClipProp.floatValue == 0)
                    {
                        EditorGUI.BeginDisabledGroup(true);
                        materialEditor.ShaderProperty(_ditherThreshold, DitherErrorTex);
                        EditorGUI.EndDisabledGroup();
                    }
                    else
                    {
                        materialEditor.ShaderProperty(_ditherThreshold, DitherTex);
                    }
                });
